...
```
"What complexity level is this task?"
...
| 2. Develop | Direct implementation | TDD with agents | TDD with agents |
...
| Complexity | Ticket | Development Agent | code-review-specialist |
|------------|--------|-------------------|------------------------|
| Simple | ❌ Skip | ❌ Direct implementation | ❌ Skip |
| Standard | ✅ Required | ✅ `backend-developer` or `frontend-developer` | ✅ Required |
...
| `backend-developer` | Backend tasks (B*.*) - DDD patterns, services |
| `frontend-developer` | Frontend tasks (F*.*) - React, components |
...
- **Adopt correct role**: Backend tasks adopt `backend-developer`, frontend tasks adopt `frontend-developer`
