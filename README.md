...
- [Architecture](./documentation/ARQUITECTURA.md) - System architecture with diagrams
- [Business Requirements](./documentation/NEGOCIO.md) - Business context and requirements
